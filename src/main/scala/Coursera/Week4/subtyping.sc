...
import Coursera.Week3.{IntSet, NonEmpty, Empty2, Empty}
...
object subtyping {
  ...
  val x: MyList[String] = Nil2                //> x  : week4.List[String] = List(Nil)
  val e = MyList()                            //> e  : week4.List[Nothing] = List(Nil)
  val xs = MyList(1,2)                        //> xs  : week4.List[Int] = List(1, 2, Nil)
